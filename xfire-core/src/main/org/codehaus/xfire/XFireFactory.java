 ...
 * <ul>
 * <li>Register your factory via <code>registerFactory</code></li>
 * <li>Implment <code>public static XFireFactory createInstance()</code>
 * </ul>
 * </p>
...
public class XFireFactory
{
    ...
    private static XFireFactory loadFactory(Class clazz)
    {
        ...
        {
            throw new RuntimeException("Couldn't load " + clazz.getName(), e);
        }
        ...
        {
            throw new RuntimeException("Couldn't load factory " + clazz.getName(), e);
        }
