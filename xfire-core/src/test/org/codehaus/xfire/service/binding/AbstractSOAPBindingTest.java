 ...
 */
public abstract class AbstractSOAPBindingTest
        extends TestCase
{
            ...
            throws Exception
    {
        ...
        soapBinding = getSOAPBinding(name);
    }

    protected abstract SOAPBinding getSOAPBinding(QName name);
            ...
            throws Exception
    {
        ...
        MockTransport transport = new MockTransport("address", "location");

        soapBinding.populateWSDLBinding(definition, wsdlBinding, transport);
        ...
        assertEquals(transport.getTransportURI(), wsdlSoapBinding.getTransportURI());
    }
            ...
            throws Exception
    {
        ...
        Transport mockTransport = new MockTransport("address", "location");
