 ...
 * 
 */
public class WSS4JProcessorsTest extends TestCase {
	...
	private void setupOutConfigFile(SecurityProcessor processor, String path) {
		...
		outBuilder
				.setConfiguration(new PropertiesLoader().loadConfigFile(path));
	 ...
	 * @throws Exception
	 */
	public void testSignatureFull() throws Exception {
		processRequest("META-INF/xfire/outsecurity_sign.properties",
	 ...
	 * @throws Exception
	 */
	public void testEncryptionFull() throws Exception {
		processRequest("META-INF/xfire/outsecurity_enc.properties",
	 ...
	 * @throws Exception
	 */
	public void testUserTokenPlain() throws Exception {
		SecurityResult result = processRequest(
				"META-INF/xfire/outsecurity_ut.properties",
	 ...
	 * @throws Exception
	 */
	public void testUserTokenDigestedValid() throws Exception {
		SecurityResult result = processRequest(
				"META-INF/xfire/outsecurity_ut_dig.properties",
	 ...
	 * @throws Exception
	 */
	public void testTimestampExpired() throws Exception {
		Document doc = readDocument("wsse-request-clean.xml");

		WSS4JOutSecurityProcessor outProcessor = new WSS4JOutSecurityProcessor();
		setupOutConfigFile(outProcessor,
				"META-INF/xfire/outsecurity_timestamp.properties");
		doc = outProcessor.process(doc).getDocument();
		assertNotNull(doc);
		Thread.sleep(2000);
		WSS4JInSecurityProcessor processor = new WSS4JInSecurityProcessor();
		setupInConfigFile(processor,
				"META-INF/xfire/insecurity_timestamp.properties");
		try {
	 ...
	 * @throws Exception
	 */
	public void testEncryptTimestampUTValid() throws Exception {

		SecurityResult result = processRequest(
				"META-INF/xfire/outsecurity_mix.properties",
